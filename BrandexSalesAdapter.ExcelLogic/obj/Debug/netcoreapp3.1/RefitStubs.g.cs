...
using BrandexSalesAdapter.ExcelLogic.RefitInternalGenerated;
...
namespace BrandexSalesAdapter.ExcelLogic.RefitInternalGenerated
{
...
namespace BrandexSalesAdapter.ExcelLogic.Services.Identity
{
    ...
    partial class AutoGeneratedIIdentityService : IIdentityService
    {
        ...
        /// <inheritdoc />
        Task<UserInputModel> IIdentityService.Register(UserInputModel loginInput)
        {
            var arguments = new object[] { loginInput };
            var func = requestBuilder.BuildRestResultFuncForMethod("Register", new Type[] { typeof(UserInputModel) });
            return (Task<UserInputModel>)func(Client, arguments);
        }
    }
}
